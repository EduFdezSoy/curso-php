...
*Tip: Usa `\n` dentro de un `echo` para insertar un salto de linea sin tener que añadir HTML*.
...
* Si han venido más personas de las que invitaste diga que la fiesta es un exito total (a parte de decir cuantas vinieron y a cuantas invitaste).  
